...
\def\milestoneId{milestone-dp01}
\def\product{LSP Services}

\setDocCompact{true}

\title{milestone-dp01: RSP redeployed on the Interim Data Facility (IDF), ready
...
\textbf{ RSP redeployed on the Interim Data Facility (IDF), ready for DP0.1} (milestone-dp01),
...
The current status of test plan \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testPlan/LVV-P79}{LVV-P79} in Jira is \textbf{ Draft }.
...
\multicolumn{2}{p{10.9cm}}{\textbf{ milestone-dp01: RSP redeployed on the Interim Data Facility (IDF), ready
for DP0.1 }} & Draft \\\hline
\multicolumn{2}{r}{ T. Cycle \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCycle/LVV-C166}{LVV-C166}:} &
\multicolumn{2}{p{10.9cm}}{\textbf{ milestone-dp01: Test RSP capabilities on IDF for DP0.1 readiness }} & Not Executed \\\hline
...
Test Cycle name: milestone-dp01: Test RSP capabilities on IDF for DP0.1 readiness\\
Status: Not Executed
